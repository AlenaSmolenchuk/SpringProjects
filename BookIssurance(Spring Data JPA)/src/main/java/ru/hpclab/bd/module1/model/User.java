...
public class User {
    ...
    @NonNull
    private List<Issurance> issurancesWithUser = new ArrayList<>();
     ...
     * @param issurancesWithUser user issurances
     */
    public User(@NonNull final UUID idUser,
                ...
                @NonNull final List<Issurance> issurancesWithUser) {
        this.idUser = idUser;
        this.fio = fio;
     ...
     */
    @NonNull
    public List<Issurance> getIssurancesWithUser() {
     ...
     */
    public void setIssurancesWithUser(@NonNull final List<Issurance> issurancesWithUser) {
        this.issurancesWithUser = issurancesWithUser;
    }
