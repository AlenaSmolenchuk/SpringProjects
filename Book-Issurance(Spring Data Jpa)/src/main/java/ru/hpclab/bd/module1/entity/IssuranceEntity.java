...
public class IssuranceEntity {
     ...
     */
    public IssuranceEntity(final Long idIssurance,
                           final Long cardNumberOfUser,
                           final Long isbnOfBook,
     ...
     */
    public void setIdIssurance(final Long idIssurance) {
        this.idIssurance = idIssurance;
    }
     ...
     */
    public Long getCardNumberOfUser() {
     ...
     */
    public void setCardNumberOfUser(final Long cardNumberOfUser) {
        this.cardNumberOfUser = cardNumberOfUser;
    }
     ...
     */
    public void setIsbnOfBook(final Long isbnOfBook) {
        this.isbnOfBook = isbnOfBook;
    }
