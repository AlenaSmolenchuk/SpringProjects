...
public class UserService {
     ...
     * @return userEntity
     */
    public UserEntity getUserById(final Long idUser) {
     ...
     */
    public UserEntity updateUser(final Long idUser, final UserEntity userEntity) {
     ...
     */
    public boolean existsUser(final Long libraryCardNumber) {
