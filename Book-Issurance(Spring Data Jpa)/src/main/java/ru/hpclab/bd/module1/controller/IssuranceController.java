...
public class IssuranceController {
    ...
    public List<Issurance> getIssurancesByIdUser(@PathVariable final Long cardNumberOfUser) {
    ...
    public void deleteIssurance(@PathVariable final Long idIssurance) {
    ...
    public Issurance updateIssurance(
            @PathVariable(required = false) final Long idIssurance,
