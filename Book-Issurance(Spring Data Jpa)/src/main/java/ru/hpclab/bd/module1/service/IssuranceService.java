...
public class IssuranceService {
     ...
     * @return list of issurances entity
     */
    public List<IssuranceEntity> getIssurancesByIdUser(final Long cardNumberOfUser) {
     ...
     */
    public IssuranceEntity updateIssurance(final Long idIssuranse, final IssuranceEntity issuranceEntity) {
     ...
     */
    public void deleteIssurance(final Long idIssurance) {
     ...
     */
    public boolean existsIssurance(final Long idIssurance) {
