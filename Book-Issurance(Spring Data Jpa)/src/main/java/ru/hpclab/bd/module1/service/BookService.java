...
public class BookService {
     ...
     * @return book entity
     */
    public BookEntity getBookByIsbn(final Long isbn) {
    ...
    public BookEntity saveBook(final BookEntity bookEntity) {
        bookEntity.setIsbn(Long.valueOf(UUID.randomUUID().toString()));
     ...
     */
    public BookEntity updateBook(final Long isbn, final BookEntity bookEntity) {
     ...
     * @param isbn book entity number
     */
    public void deleteBook(final Long isbn) {
     ...
     */
    public boolean existBook(final Long isbn) {
